...
export default function ReportPage() {
  ...
  const handleDownload = async () => {
    try {
      const report = document.querySelector('.report-pdf') as HTMLElement;
      if (!report) throw new Error('Report content not found');
      ...
      const pdf = new jsPDF();
      pdf.text('Empty Report (Preview Only)', 20, 20);
      pdf.save('ColoriAI_Report.pdf');
    }
  };
  ...
  return (
    <TransitionWrapper>
      <div className="mobile-display">
        <div className="report-pdf flex flex-col h-screen">
          {/* Header - Fixed */}
          <div className="bg-[#FEDCB6] h-[202px] flex flex-col items-center justify-start px-4 pt-6">
            <div className="w-full flex justify-between items-center">
              <div className={styles.back} onClick={() => window.history.back()}>&lt;</div>
              <Link href="/profile">
                <div
          ...
          {/* Body - Scrollable */}
          <div className="flex-1 overflow-y-auto bg-[#FCF2DF]">
            <div className="p-6 text-[#3c3334] text-sm font-medium">
              {/* User Info */}
              <div className="mt-[20px] mb-[10px] flex justify-center gap-[50px] text-sm">
                <p>
                  ...
                  <span className="text-black font-[400] text-[18px] leading-none tracking-[1.44px] capitalize font-[Quicksand]">Audreycmk</span>
                </p>
                <p>
                  <span className="text-black font-[600] text-[18px] leading-none tracking-[1.44px] capitalize font-[Quicksand]">Age:</span>{' '}
                  <span className="text-black font-[400] text-[18px] leading-none tracking-[1.44px] capitalize font-[Quicksand]">23</span>
                </p>
              </div>
